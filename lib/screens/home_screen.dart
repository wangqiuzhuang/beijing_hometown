...
class _HomeScreenState extends State<HomeScreen> {
          ...
          if (_showFab)
            Positioned(
              ...
              child: FloatingActionButton(
                ...
                elevation: 4,
                onPressed: () => _scrollController.animateTo(0, duration: const Duration(milliseconds: 500), curve: Curves.easeInOutCubic),
  ...
  // ── AI 智能行程入口 ──
  Widget _buildAiEntryCard(dynamic colors, dynamic t) {
...
class _NavItem extends StatefulWidget {
  ...
  const _NavItem({required this.icon, required this.activeIcon, required this.label, required this.onTap, required this.colors});
