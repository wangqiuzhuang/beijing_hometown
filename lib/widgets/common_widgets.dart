          ...
          Column(
            ...
            children: [
              ...
              if (subtitle != null) ...[
                ...
                Text(subtitle!, style: TextStyle(fontSize: 11, color: colors.textLight, letterSpacing: 1.5, fontWeight: FontWeight.w500)),
              ],
            ],
          ),
        ],
...
class HighlightCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(colors: [colors.primary.withValues(alpha: 0.04), colors.accent.withValues(alpha: 0.08)]),
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Text(text, style: TextStyle(fontSize: 14, color: colors.textMedium, height: 1.6))),
        ],
      ),
    );
  }
